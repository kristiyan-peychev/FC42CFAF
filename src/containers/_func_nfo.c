...
inline unsigned get_arg_len_func_nfo(_func_nfo *target) 
{
	return target->arg_len;
}

inline long long int get_flags_func_nfo(_func_nfo *target)
{
	return target->flags;
}
